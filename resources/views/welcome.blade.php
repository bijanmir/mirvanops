...
<body class="antialiased min-h-screen">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between h-20">
                ...
                <div class="flex items-center space-x-3">
                    ...
                    <a href="{{ route('login') }}" class="hidden sm:inline-flex items-center justify-center h-10 px-4 text-secondary hover:text-primary transition-colors font-medium">Sign In</a>
                    <a href="{{ route('register') }}" class="btn-primary h-10 px-5 rounded-xl font-medium inline-flex items-center justify-center">Get Started</a>
                </div>
            </div>
        </div>
    </nav>
    ...
    <!-- Hero Section -->
    <section class="relative hero-gradient pt-16 pb-32 overflow-hidden">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center max-w-4xl mx-auto">
                <div class="inline-flex items-center px-4 py-2 rounded-full glass-card text-sm text-secondary mb-8">
                    <span class="w-2 h-2 rounded-full bg-green-500 mr-2 animate-pulse"></span>
                    Now in Beta — Free for early adopters
                </div>
                
                <h1 class="text-4xl sm:text-5xl lg:text-6xl font-bold text-primary leading-tight mb-6">
                    Property Management<br>
                    <span class="gradient-text">Made Simple</span>
                </h1>
                
                <p class="text-lg sm:text-xl text-secondary max-w-2xl mx-auto mb-10">
                ...
                <div class="flex flex-col sm:flex-row items-center justify-center gap-4">
                    ...
                    <a href="#features" class="btn-secondary h-14 px-8 rounded-xl font-semibold text-lg inline-flex items-center justify-center">
                        See Features
                    </a>
                </div>

                <p class="text-sm text-muted mt-6">No credit card required • Free for up to 10 units</p>
            </div>
            ...
            <div class="mt-20 relative max-w-5xl mx-auto">
                ...
                <div class="glass-card rounded-2xl p-2">
                    <div class="dashboard-preview rounded-xl p-4 sm:p-8">
                        <!-- Fake Dashboard UI -->
                        ...
                        <div class="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-6">
                            ...
                            <div class="bg-white/10 rounded-xl p-4">
                                ...
                                <p class="text-xs text-gray-400">Properties</p>
                            </div>
                            <div class="bg-white/10 rounded-xl p-4">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div class="bg-white/5 rounded-xl p-4 h-32 flex items-center justify-center">
                                <span class="text-gray-500 text-sm">Payments Chart</span>
                            </div>
                            <div class="bg-white/5 rounded-xl p-4 h-32 flex items-center justify-center">
                                <span class="text-gray-500 text-sm">Recent Activity</span>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <!-- Features Section -->
    <section id="features" class="relative feature-gradient py-24">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-16">
                <h2 class="text-3xl sm:text-4xl font-bold text-primary mb-4">Everything You Need</h2>
                <p class="text-lg text-secondary max-w-2xl mx-auto">Powerful tools to manage your properties efficiently, all in one place.</p>
            </div>

            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                <!-- Feature 1 -->
                <div class="feature-card glass-card rounded-2xl p-6 group">
                    ...
                    <h3 class="text-lg font-semibold text-primary mb-2">Payment Tracking</h3>
                ...
                <div class="feature-card glass-card rounded-2xl p-6 group">
                    ...
                    <h3 class="text-lg font-semibold text-primary mb-2">Property Management</h3>
                ...
                <div class="feature-card glass-card rounded-2xl p-6 group">
                    ...
                    <h3 class="text-lg font-semibold text-primary mb-2">Tenant Management</h3>
                ...
                <div class="feature-card glass-card rounded-2xl p-6 group">
                    <div class="w-12 h-12 rounded-xl bg-cyan-500/15 flex items-center justify-center mb-4 group-hover:bg-cyan-500/25 transition-colors">
                        <svg class="w-6 h-6 text-cyan-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" /></svg>
                    </div>
                    <h3 class="text-lg font-semibold text-primary mb-2">Lease Tracking</h3>
                ...
                <div class="feature-card glass-card rounded-2xl p-6 group">
                    ...
                    <h3 class="text-lg font-semibold text-primary mb-2">Maintenance Requests</h3>
                ...
                <!-- Feature 6 -->
                <div class="feature-card glass-card rounded-2xl p-6 group">
                    <div class="w-12 h-12 rounded-xl bg-rose-500/15 flex items-center justify-center mb-4 group-hover:bg-rose-500/25 transition-colors">
    ...
    <!-- Pricing Section -->
    <section id="pricing" class="py-24" style="background-color: var(--bg-secondary);">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-16">
                <h2 class="text-3xl sm:text-4xl font-bold text-primary mb-4">Simple Pricing</h2>
                <p class="text-lg text-secondary max-w-2xl mx-auto">Start free, upgrade as you grow.</p>
            </div>

            <div class="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
                <!-- Free -->
                <div class="pricing-card rounded-2xl p-8">
                    <h3 class="text-lg font-semibold text-primary mb-2">Starter</h3>
                    <p class="text-muted text-sm mb-6">Perfect for getting started</p>
                    <div class="mb-6">
                    ...
                    <a href="{{ route('register') }}" class="btn-secondary w-full h-12 rounded-xl font-medium flex items-center justify-center">Get Started</a>
                </div>

                <!-- Pro -->
                <div class="pricing-card featured rounded-2xl p-8 relative">
                    <div class="absolute -top-3 left-1/2 -translate-x-1/2 bg-gradient-to-r from-amber-500 to-amber-600 text-white text-xs font-bold px-4 py-1 rounded-full">POPULAR</div>
                    <h3 class="text-lg font-semibold text-primary mb-2">Professional</h3>
                    <p class="text-muted text-sm mb-6">For growing portfolios</p>
                    <div class="mb-6">
                    ...
                    <a href="{{ route('register') }}" class="btn-primary w-full h-12 rounded-xl font-medium flex items-center justify-center">Start Free Trial</a>
                </div>

                <!-- Enterprise -->
                <div class="pricing-card rounded-2xl p-8">
                    <h3 class="text-lg font-semibold text-primary mb-2">Enterprise</h3>
                    <p class="text-muted text-sm mb-6">For large portfolios</p>
                    <div class="mb-6">
                    ...
                    <a href="{{ route('register') }}" class="btn-secondary w-full h-12 rounded-xl font-medium flex items-center justify-center">Contact Sales</a>
                </div>
            </div>
        </div>
    </section>
    ...
    <!-- Footer -->
    <footer id="contact" class="border-t border-primary py-12" style="background-color: var(--bg-secondary);">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                ...
                <div>
                    <h4 class="text-sm font-semibold text-primary uppercase tracking-wide mb-4">Product</h4>
                    <ul class="space-y-2">
                        <li><a href="#features" class="text-secondary hover:text-primary text-sm transition-colors">Features</a></li>
                        <li><a href="#pricing" class="text-secondary hover:text-primary text-sm transition-colors">Pricing</a></li>
                    </ul>
                </div>
                <div>
                    <h4 class="text-sm font-semibold text-primary uppercase tracking-wide mb-4">Contact</h4>
                    <ul class="space-y-2">
                        <li><a href="mailto:support@mirvaninc.com" class="text-secondary hover:text-primary text-sm transition-colors">support@mirvaninc.com</a></li>
                    </ul>
                </div>
            </div>
