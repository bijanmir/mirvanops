<div class="max-w-2xl mx-auto">
    ...
    <div class="glass-card rounded-2xl overflow-hidden">
        <div class="p-4 sm:p-6 border-b border-primary">
            <h1 class="text-xl sm:text-2xl font-bold text-primary">{{ $property ? 'Edit Property' : 'Add New Property' }}</h1>
            <p class="text-muted mt-1">{{ $property ? 'Update property information' : 'Enter the property details below' }}</p>
        </div>
        ...
        <form wire:submit="save" class="p-4 sm:p-6 space-y-6">
            ...
            <div>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-3 gap-3">
                    <label class="relative cursor-pointer">
                        ...
                        <div class="p-4 bg-input border border-primary rounded-xl text-center peer-checked:border-accent peer-checked:bg-accent/10 transition-all">
                            <div class="w-10 h-10 rounded-lg badge-success flex items-center justify-center mx-auto mb-2">
                    ...
                    <label class="relative cursor-pointer">
                        ...
                        <div class="p-4 bg-input border border-primary rounded-xl text-center peer-checked:border-accent peer-checked:bg-accent/10 transition-all">
                            <div class="w-10 h-10 rounded-lg badge-info flex items-center justify-center mx-auto mb-2">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <label class="relative cursor-pointer">
                        ...
                        <div class="p-4 bg-input border border-primary rounded-xl text-center peer-checked:border-accent peer-checked:bg-accent/10 transition-all">
                            <div class="w-10 h-10 rounded-lg bg-purple-500/15 text-purple-500 flex items-center justify-center mx-auto mb-2">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="flex flex-col-reverse sm:flex-row gap-3 pt-4">
                <a href="{{ route('properties.index') }}" class="btn-secondary flex-1 px-6 py-3 rounded-xl font-medium text-center">
                    Cancel
                </a>
